...
var someone = (firstName: "Mary", age: 35)
...
print("\(someone.firstName) is \(someone.age) years old")
...
print("Happy \(someone.age) birthday, \(someone.firstName)!")
...
//no because human is a let constant
